...
public class AuditServiceImpl implements AuditService {
    ...
    public void logLogin(Long userId, String username, String ipAddress, String userAgent) {
        CreateAuditLogDto dto = CreateAuditLogDto.builder()
                ...
                .details("{\"success\": true, \"type\": \"normal\", \"username\": \"" + username + "\"}")
                .ipAddress(ipAddress)
                .userAgent(userAgent)
                .build();
    ...
    public void logFailedLogin(String username, String ipAddress, String userAgent) {
        log.info("🔍 Intentando registrar login fallido para usuario: {}", username);
        ...
        try {
            AuditLogResponseDto result = create(dto, null);
            log.info("✅ Login fallido registrado exitosamente con ID: {}", result.getId());
        } catch (Exception e) {
            log.error("❌ Error al registrar login fallido: {}", e.getMessage(), e);
        }
    }
