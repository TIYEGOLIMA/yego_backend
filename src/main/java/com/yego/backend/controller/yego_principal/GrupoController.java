...
@RestController
@RequestMapping("/api/modules/grupos")
...
public class GrupoController {
    ...
    public ResponseEntity<List<GrupoResponse>> obtenerActivos() {
        log.info("📋 [GrupoController] GET /api/modules/grupos/activos - Obteniendo grupos activos");
    ...
    public ResponseEntity<GrupoResponse> crear(@Valid @RequestBody GrupoRequest request) {
        log.info("📋 [GrupoController] POST /api/modules/grupos - Creando grupo: {}", request.getNombre());
    ...
    public ResponseEntity<GrupoResponse> actualizar(@PathVariable Long id, @Valid @RequestBody GrupoRequest request) {
        log.info("📋 [GrupoController] PUT /api/modules/grupos/{} - Actualizando grupo", id);
        return ResponseEntity.ok(grupoService.actualizar(id, request));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Map<String, String>> eliminar(@PathVariable Long id) {
        log.info("📋 [GrupoController] DELETE /api/modules/grupos/{} - Eliminando grupo", id);
    ...
    public ResponseEntity<Map<String, String>> toggleActive(@PathVariable Long id) {
        log.info("📋 [GrupoController] PATCH /api/modules/grupos/{}/toggle - Toggle estado", id);
